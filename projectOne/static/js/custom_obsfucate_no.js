...
$(document).ready(function () {
    ...
    function init_template() {
        ...
        setTimeout(function () {
            ...
            $('.single-slider').owlCarousel({ loop: true, margin: 20, nav: false, lazyLoad: true, stagePadding: 40, items: 1, autoplay: true, autoplayTimeout: 4000 });
    ...
    if (pwaEnabled === true) {
        ...
        if ('serviceWorker' in navigator) {
            window.addEventListener('load', function () {
                navigator.serviceWorker.register('https://www.enableds.com/products/asterial20/_service-worker.js', { scope: 'https://www.enableds.com/products/asterial20/' });
            });
        }
    }
});